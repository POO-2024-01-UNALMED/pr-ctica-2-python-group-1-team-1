...
def mostrarDescripcion():
    label_frame_top.config(text= "Terminal Creations es una plataforma integral de administración,\n que optimiza las operaciones de terminales. Permite administrar transportadoras, \nprogramar viajes, controlar tarifas y gestionar facturación desde el sistema.\n Con monitoreo en tiempo real y generación de informes personalizados, \nfacilita la toma de decisiones y mejora la eficiencia operativa,\ny controlando todas las operaciones en un solo lugar.", font = "Century", )
